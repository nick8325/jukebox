module Data.Derive.BinaryShared where
{-
import BinaryShared
import Data.Word
...
makeBinaryShared :: Derivation
makeBinaryShared = derivationDSL "BinaryShared" dslBinaryShared
...
dslBinaryShared =
    ...
    "Ident" (List [String "return"])])]),App "Paren" (List [App
    "ExpTypeSig" (List [App "Lit" (List [App "Int" (List [Int 0])]),
    App "TyCon" (List [App "UnQual" (List [App "Ident" (List [Concat (
    List [String "Word",ShowInt (Int 8)])])])])])])])])]),App "BDecls"
    (List [List []])])]])])])])]
-- GENERATED STOP
